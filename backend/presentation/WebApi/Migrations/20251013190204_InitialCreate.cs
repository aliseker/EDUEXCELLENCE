        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Program = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseDailyPrograms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseDailyPrograms_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "IsActive", "IsSuperAdmin", "LastLoginAt", "LastName", "PasswordHash", "PhoneNumber", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2025, 10, 13, 19, 2, 4, 499, DateTimeKind.Utc).AddTicks(4352), "admin@edu-excellence.com", "Admin", true, true, null, "User", "$2a$11$UZkZIxW3TUQo/Hj/ecm74.n7IXJNyB.ZO1naY8hP3rwQPdPIAM4pe", null, null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseDailyPrograms_CourseId",
                table: "CourseDailyPrograms",
                column: "CourseId");
